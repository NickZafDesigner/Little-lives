...
export const CHAT_SCRIPTS: Record<ChatNpcId, ChatScript> = {
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          {
            id: "friend_secret",
            label: "Share a kitchen secret",
            playerLine: "Between friends - what's your real secret ingredient?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "You mean the world",
            playerLine: "Mabel, your kitchen feels like home. Thank you for that.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Dream about forever",
            playerLine: "If we had forever of mornings like this, I'd never leave.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: [
          "Butter at room temperature… and a friend who listens. That's the secret.",
        ],
        choices: [
          {
            id: "deep_friend_bye",
            label: "I'll remember that",
            playerLine: "Room-temp butter and good company. Got it.",
            affinity: 6,
            next: null,
          },
        ],
      ...
      deep_close: {
        id: "deep_close",
        npcLines: [
          "Oh sweetheart. Come here - flour hugs are free for close friends.",
        ],
        choices: [
          {
            id: "deep_close_bye",
            label: "Hug accepted",
            playerLine: "Best hug in town. Even with flour.",
            affinity: 8,
            next: null,
          },
        ],
      ...
      deep_bestie: {
        id: "deep_bestie",
        npcLines: [
          "Then stay. My spare apron has your name on it. Best friends bake forever.",
        ],
        choices: [
          {
            id: "deep_bestie_bye",
            label: "I'm in",
            playerLine: "Deal. Forever mornings, forever shortbread.",
            affinity: 10,
            next: null,
          },
        ],
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          {
            id: "friend_secret",
            label: "Trade barista secrets",
            playerLine: "Friend to friend - what's the real latte trick?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "You keep me grounded",
            playerLine: "Your café is my favourite reset button.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Open a café together?",
            playerLine: "Someday we should open a tiny café just for friends.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["Microfoam patience. And never rush a friend."],
        choices: [{ id: "deep_friend_bye", label: "Noted", playerLine: "Patience. Got it.", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["Then take the stool by the window. It's yours whenever."],
        choices: [{ id: "deep_close_bye", label: "I'll be back", playerLine: "Saving that stool.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["Best-friend partnership. Your name on the chalkboard - permanent."],
        choices: [{ id: "deep_bestie_bye", label: "Deal", playerLine: "Chalk me in forever.", affinity: 10, next: null }],
      },
      drink: {
        id: "drink",
        npcLines: [
  ...
  pip: {
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          },
          {
            ...
            playerLine: "Are we park pals forever, Pip?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "You make days brighter",
            playerLine: "You make ordinary days feel like festivals.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Plant a whole meadow",
            playerLine: "Let's plant a whole meadow together someday.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["Forever and a daisy. Pinkie swear."],
        choices: [{ id: "deep_friend_bye", label: "Pinkie swear", playerLine: "Pinkie swear!", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["Aww. Come sit under the big tree. Best seats in friendship."],
        choices: [{ id: "deep_close_bye", label: "Let's sit", playerLine: "Best seats ever.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["A meadow with our names in wildflowers. Best friends grow things."],
        choices: [{ id: "deep_bestie_bye", label: "I'm in", playerLine: "Let's grow it together.", affinity: 10, next: null }],
      },
      cool: {
        id: "cool",
        npcLines: [
  ...
  vera: {
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          },
          {
            ...
            playerLine: "Friend to friend - what's your best business tip?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            ...
            playerLine: "I trust your judgment more than anyone's ledger.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Partner up someday?",
            playerLine: "Someday we should run a stall together - just once.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["Never discount your own time. And never short a friend."],
        choices: [{ id: "deep_friend_bye", label: "Wise", playerLine: "I'll remember both.", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["Flattery won't get you free jam. …Okay, maybe one jar."],
        choices: [{ id: "deep_close_bye", label: "Deal", playerLine: "Secret jam privilege unlocked.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["Best friends get the real ledger. Don't make me regret it."],
        choices: [{ id: "deep_bestie_bye", label: "I won't", playerLine: "Your secret's safe with me.", affinity: 10, next: null }],
      },
      browse: {
        id: "browse",
        npcLines: [
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          {
            id: "friend_secret",
            label: "Ask what they're reading",
            playerLine: "Friend privilege - what are you really reading?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "Your quiet means a lot",
            playerLine: "Your quiet corners make the loud days survivable.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Write something together",
            playerLine: "Maybe someday we write a little book together.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["A poem I shouldn't admit to liking. …Don't tell the shelves."],
        choices: [{ id: "deep_friend_bye", label: "Secret kept", playerLine: "Shelves will never know.", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["Then stay in the quiet with me awhile. Close friends welcome."],
        choices: [{ id: "deep_close_bye", label: "Gladly", playerLine: "Quiet company is perfect.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["A book with two authors. Best friends share chapters."],
        choices: [{ id: "deep_bestie_bye", label: "Chapter one", playerLine: "I'll bring the first line.", affinity: 10, next: null }],
      },
      book: {
        id: "book",
        npcLines: [
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          {
            id: "friend_secret",
            label: "Ask how they recharge",
            playerLine: "Friend to friend - how do you recharge after long days?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "You look after everyone",
            playerLine: "You look after everyone. Who looks after you?",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Tea every week",
            playerLine: "Promise me tea every week - doctor's orders, reversed.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["Herbal tea. No charts. Just steam and stillness."],
        choices: [{ id: "deep_friend_bye", label: "Sounds perfect", playerLine: "I'll try that tonight.", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["Close friends do. Thank you for asking - truly."],
        choices: [{ id: "deep_close_bye", label: "Anytime", playerLine: "Anytime. I mean it.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["Best-friend tea is a standing order. Don't skip doses."],
        choices: [{ id: "deep_bestie_bye", label: "I won't", playerLine: "Weekly tea - locked in.", affinity: 10, next: null }],
      },
      well: {
        id: "well",
        npcLines: [
    ...
    nodes: {
      hello: {
        ...
        choices: [
          ...
          {
            id: "friend_secret",
            label: "Ask about craft",
            playerLine: "Friend to friend - what's the trick to clean joints?",
            affinity: 10,
            next: "deep_friend",
            minScore: 40,
          },
          {
            id: "close_heart",
            label: "I admire your steadiness",
            playerLine: "Your steadiness keeps this whole town standing.",
            affinity: 14,
            next: "deep_close",
            minScore: 70,
          },
          {
            id: "bestie_future",
            label: "Build something ours",
            playerLine: "Someday let's build something that is just ours.",
            affinity: 16,
            next: "deep_bestie",
            minScore: 100,
          },
      ...
      deep_friend: {
        id: "deep_friend",
        npcLines: ["Measure twice. And don't rush a friend mid-cut."],
        choices: [{ id: "deep_friend_bye", label: "Wise words", playerLine: "Measure twice. Got it.", affinity: 6, next: null }],
      },
      deep_close: {
        id: "deep_close",
        npcLines: ["…Thanks. Close friends get the good scrap maple."],
        choices: [{ id: "deep_close_bye", label: "Honoured", playerLine: "I'll put it to good use.", affinity: 8, next: null }],
      },
      deep_bestie: {
        id: "deep_bestie",
        npcLines: ["A bench with two names carved under. Best friends build forever."],
        choices: [{ id: "deep_bestie_bye", label: "Let's build it", playerLine: "I'll bring the clamps.", affinity: 10, next: null }],
      },
      shop: {
        id: "shop",
        npcLines: [
